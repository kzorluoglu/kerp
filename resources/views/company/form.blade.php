        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                <div class="position-relative form-group">
                    ...
                    <texteditor inputname="address"
                                inputvalue="@if($company){!! $company->address !!}@endif"></texteditor>
                </div>
                <div class="position-relative form-group">
                    {{  Form::label('information', __('company.information')) }}
                    <texteditor inputname="information"
                                inputvalue="@if($company){!! $company->information !!}@endif"></texteditor>
                </div>
                @if($company->logo)
                    <div class="position-relative form-group">
        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                <div class="position-relative form-group">
                    ...
                    <small id="currency" class="form-text text-muted">{{ __('app.required_input') }}
                        , {{ __('company.currency_help') }}</small>
                </div>
                <div class="position-relative form-group">
                ...
                <div class="position-relative form-group">
                    ...
                    @if($company->tax_rate == 0)
                        <small id="tax_rate"
                               class="form-text text-muted">{!! __('company.tax_rate_0_information') !!}</small>
                    @endif
                </div>
                <div class="position-relative form-group">
                </div>
