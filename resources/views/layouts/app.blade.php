                ...
                <div class="scrollbar-sidebar">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                <a href="{{ route('company') }}" class="{{ Route::is('company*') ? 'mm-active' : '' }}">
                            ...
                            <li>
                                <a href="{{ route('product') }}" class="{{ Route::is('product*') ? 'mm-active' : '' }}">
                            ...
                            <li>
                                <a href="{{ route('customer') }}" class="{{ Route::is('customer*') ? 'mm-active' : '' }}">
                                    <i class="metismenu-icon pe-7s-users"></i>
                                    {{__('app.customers')}}
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('invoice') }}" class="{{ Route::is('invoice*') ? 'mm-active' : '' }}">
