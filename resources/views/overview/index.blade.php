                    ...
                    @if(count($invoices) > 0)
                        ...
                        <table class="mb-0 table table-hover">
                            ...
                            <tr>
                                ...
                                <th scope="col">{{__('overview.company_name')}} ( {{__('overview.firstname')}}
                                    , {{__('overview.lastname')}} )
                                </th>
                            ...
                            @foreach($invoices as $invoice)
                                <tr>
                                    ...
                                    <td>{{ $invoice->company_name }} ({{ $invoice->firstname }} {{ $invoice->lastname }}
                                        )
                                    </td>
                    ...
                    @if(count($incoming_invoices) > 0)
                        ...
                        <table class="mb-0 table table-hover">
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td class="text-right">{{__('overview.total_sum')}}</td>
                                <td>{!! number_format($incoming_invoicesTotalSumWithoutTax, 2, ',', '.') !!} {!! $invoice->company->currency !!}</td>
                                <td>{!! number_format($incoming_invoicesTotalSumTax, 2, ',', '.') !!} {!! $invoice->company->currency !!}</td>
                                <td>{!! number_format($incoming_invoicesTotalSum, 2, ',', '.') !!} {!! $invoice->company->currency !!}</td>
                            </tr>
                            </tfoot>
                        </table>
                    @else
