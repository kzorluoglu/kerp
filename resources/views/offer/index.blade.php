                ...
                <table class="mb-0 table table-hover">
                    ...
                    <tbody>
                            ...
                            <tr @if($offer->invoice_number) class="table-success" @endif>
                                <th scope="row">{{ $offer->offer_number }} @if($offer->invoice_number) <span class="badge badge-success badge-pill">{{ __('offer.hasinvoice')}}</span> @endif</th>
                                ...
                                <td>{{ $offer->city }}</td>
                                <td>
                                    <a href="{{ route('offer.prepare', $offer->id) }}" class="mb-2 mr-2 btn btn-light"><i class="metismenu-icon pe-7s-pen"></i></a>
                                    <a href="{{ route('offer.changetoinvoice', $offer->id) }}" title="{{ __('offer.changetoinvoice')}}" class="mb-2 mr-2 btn btn-primary"><i class="metismenu-icon pe-7s-paper-plane"></i></a>
                                    <a class="mb-2 mr-2 btn btn-success" title="{!! __('offer.pdf_preview') !!}" target="_blank" href="{{ route('offer.pdf', $offer->id ) }}"><i class="metismenu-icon pe-7s-file"></i></a>
                                    <a class="mb-2 mr-2 btn btn-success" title="{!! __('offer.download') !!}" target="_blank" href="{{ route('offer.download', $offer->id ) }}"><i class="metismenu-icon pe-7s-download"></i></a>
