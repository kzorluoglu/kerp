<div class="row">
    <div class="col-md text-center">
        <a class="btn btn-success" target="_blank"
           href="{{ route('offer.pdf', $offer->id ) }}">{!! __("offer.pdf_preview") !!}</a>
        <a class="btn btn-success" target="_blank"
           href="{{ route('offer.download', $offer->id ) }}">{!! __("offer.download") !!}</a>
    </div>
</div>
<br>
<br>
        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 font-weight-bold">{!! __('offer.product_count') !!}
                        - {!! __('offer.product_type') !!}</div>
                    ...
                    <div class="col-md">
                        <table align="right" style="font-size:16px;">
                            <tr>
                                ...
                                <td>:</td>
                                <td class="p-1"
                                    align="right">{!! number_format($sum_price_total, 2, ',', '.') !!} {!! $offer->company->currency !!}</td>
                            </tr>
                            @if($offer->tax_rate > 0)
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td class="p-1"
                                        align="right">{!! number_format($sum_tax, 2, ',', '.') !!} {!! $offer->company->currency !!}</td>
                                </tr>
                            @endif
                            <tr>
                                ...
                                <td>:</td>
                                <td class="p-1"
                                    align="right">{!! number_format($sum_total, 2, ',', '.') !!} {!! $offer->company->currency !!}</td>
                            </tr>
                        </table>
                    </div>
                </div>
                    ...
                    <div class="col-md">
                        ...
                        <div class="position-relative form-group">
                            <texteditor inputname="information"
                                        inputvalue="@if($offer->information){!! $offer->information !!}@endif"></texteditor>
                        </div>
                        ...
                        <div class="position-relative form-group">
                            <button type="submit"
                                    class="btn btn-primary">{!! __("offer.update_information") !!}</button>
                        </div>
                        {!!  Form::close() !!}
                    </div>
                </div>
