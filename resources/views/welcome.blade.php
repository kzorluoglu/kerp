                            ...
                            <ul class="slimmenu main-menu">
                                @auth
                                    <li><a href="{{ route('home') }}"
                                           class=" btn btn-primary"><span>{{ __('welcome.home') }}</span></a></li>
                                @endauth
                                <li><a href="#feature" class="js-scroll-trigger">{{ __('welcome.menu_feature') }}</a>
                                </li>
                                <li><a href="#contact" class="js-scroll-trigger">{{ __('welcome.menu_contact') }}</a>
                                </li>
                                <li><select id="language" class="form-control " name="language"
                            ...
                            <ul class="banner-ads-btn m-0 list-inline">
                                @guest
                                    <li class="list-inline-item"><a href="{{ route('login') }}"
                                                                    class="ads-btn1 btn btn-primary"><span>{{ __('welcome.banner_login') }}</span></a>
                                    </li>
                                    @if(Route::has('register'))
                                        <li class="list-inline-item"><a href="{{ route('register') }}"
                                                                        class="ads-btn2 btn btn-primary"><span>{{ __('welcome.banner_register') }}</span></a>
                                        </li>
                                    @endif
                                @endguest
                                @auth
                                    <li class="list-inline-item"><a href="{{ route('home') }}"
                                                                    class="ads-btn1 btn btn-primary"><span>{{ __('welcome.home') }}</span></a>
                                    </li>
                                @endauth
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="service-box" data-aos="fade-up">
                            <div class="service-logo"><img src="assets/images/service-icon.png" alt="service icon"/>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="service-box" data-aos="fade-up">
                            <div class="service-logo"><img src="assets/images/service-icon2.png" alt="service icon"/>
                            </div>
                            <div class="service-content">
                    ...
                    <div class="col-md-4">
                        <div class="service-box" data-aos="fade-up">
                            <div class="service-logo"><img src="assets/images/service-icon3.png" alt="service icon"/>
                            </div>
                            <div class="service-content">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="feature-box" data-aos="fade-right">
                                    <div class="feature-logo"><img src="assets/images/feature-icon1.png"
                            ...
                            <div class="col-md-6">
                                <div class="feature-box">
                                    <div class="feature-logo"><img src="assets/images/feature-icon2.png"
                                                                   alt="feature icon"/></div>
                                    <div class="feature-content">
                            ...
                            <div class="col-md-6">
                                <div class="feature-box">
                                    <div class="feature-logo"><img src="assets/images/feature-icon3.png"
                                                                   alt="feature icon"/></div>
                                    <div class="feature-content">
                            ...
                            <div class="col-md-6">
                                <div class="feature-box" data-aos="fade-right">
                                    <div class="feature-logo"><img src="assets/images/feature-icon4.png"
                                                                   alt="feature icon"/></div>
                                    <div class="feature-content">
            ...
            <div class="newsletter-wrapper">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-7">
                        <div class="newsletter-img float-right"><img src="assets/images/newsletter-img.png"
                            ...
                            <form action="#">
                                <div class="form-group">
                                    <input type="email" class="form-control"
                                           placeholder="{{ __('welcome.contact_mail') }}">
                                </div>
                                <div class="form-group">
                                    <textarea class="form-control" placeholder="{{ __('welcome.contact_message') }}"
                                              rows="5"></textarea>
                                </div>
                                <div class="form-group m-0">
                                    <button class=" btn-primary btn-block"
                                            type="submit">{{ __('welcome.contact_buton') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="footer-widget-wrraper">
                <div class="row">
                    <div class="col-md-12 col-lg-12 text-center">
                        <a href="#" class="footer-logo"><img src="assets/images/kbitsoftware.png"
                                                             alt="footer logo"/></a>
                    </div>
                </div>
            </div>
